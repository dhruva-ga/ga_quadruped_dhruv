...
class ParamLegsKinematics:
    def __init__(self,manager):
        ...
        self.motors = []
        self.motors.append(Motor(1,self.manager,50,2.0,5.0,1.0,MotorType.X8_90,10))
        self.motors.append(Motor(2,self.manager,120,2.0,5.0,1.0,MotorType.X8_90,10))
        self.motors.append(Motor(3,self.manager,80,2.0,5.0,1.0,MotorType.X8_90,10))
